...
use App\Http\Controllers\Admin\Jummah\JummahController;
...
Route::prefix('admin')->middleware('backendLang')->name('admin.')->group(function(){
    ...
    Route::middleware('admin','adminStatusCheck')->group(function(){
        ...
        /** Jummah Start */
        Route::resource('jummah',JummahController::class)->except('create','show');
        Route::controller(JummahController::class)->prefix('jummah')->group(function () {
            Route::get('/update/status/{id}/{status}', 'updateStatus');
        });
        /** Jummah End */
