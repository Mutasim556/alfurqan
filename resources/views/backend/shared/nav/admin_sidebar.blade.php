<ul class="sidebar-links" id="simple-bar">
    ...
    @endif
    @if (hasPermission(['event-index', 'event-create', 'event-update', 'event-delete']))
        <li class="sidebar-list">
            <a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.event.index') }}" aria-expanded="false"><i
                    data-feather="archive"></i><span>{{ __('admin_local.Events') }}</span>
            </a>
        </li>
    @endif
    @if (hasPermission(['jummah-index', 'jummah-create', 'jummah-update', 'jummah-delete']))
        <li class="sidebar-list">
            <a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.jummah.index') }}" aria-expanded="false"><i
                    data-feather="pocket"></i><span>{{ __('admin_local.Jummah') }}</span>
            </a>
        </li>
    @endif
    @if (hasPermission([
