...
@section('content')
    ...
    <div class="modal fade" id="add-service-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg"
        aria-hidden="true">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <button class="btn btn-success" type="btn" data-bs-toggle="modal"
                                        data-bs-target="#add-service-modal">+ {{ __('admin_local.Add service') }}</button>
                                </div>
                            </div>
                        @endif
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-content">
                                                        ...
                                                        <a data-bs-toggle="modal" style="cursor: pointer;"
                                                            data-bs-target="#edit-service-modal" class="text-primary"
