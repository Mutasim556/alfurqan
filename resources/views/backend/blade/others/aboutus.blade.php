        ...
        <div class="row">
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.updateAboutUs') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                        ...
                                        @foreach (getLangs() as $lang)
                                            ...
                                            @php
                                                ...
                                                if(count($aboutus->translations)>0){
                                                    ...
                                                    foreach ($aboutus->translations as $key => $translation) {
                                                        if($translation->locale==$lang->lang && $translation->key=='about_us_title'){
                                                            $translate[$lang->lang]['about_us_title'] = $translation->value;
                                                        }
                                                        if($translation->locale==$lang->lang && $translation->key=='short_details'){
                                                            $translate[$lang->lang]['short_details'] = $translation->value;
                                                        }
                                                        if($translation->locale==$lang->lang && $translation->key=='details'){
                                            ...
                                            <div class="tab-pane fade" id="pills-{{ $lang->name }}" role="tabpanel"
                                                ...
                                                <div class="form-group">
                                                    <label for="">{{ __('admin_local.About Us Title') }} (
                                                        {{ $lang->name }} )</label>
                                                    <input type="text" class="form-control" name="about_us_title_{{ $lang->lang }}" id="about_us_title_{{ $lang->lang }}"  value="{{ isset($translate[$lang->lang]['about_us_title'])?$translate[$lang->lang]['about_us_title']:'' }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">{{ __('admin_local.Short Details') }} (
                                                        {{ $lang->name }} ) </label>
                                                    <input type="text" class="form-control" name="short_details_{{ $lang->lang }}" id="short_details_{{ $lang->lang }}"  value="{{ isset($translate[$lang->lang]['short_details'])?$translate[$lang->lang]['short_details']:'' }}">
                                                </div>
                                                <div class="form-group">
...
@push('js')
    ...
    <script>
        ...
        var form_url = "{{ route('admin.service.store') }}";
