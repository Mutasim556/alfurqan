        ...
        <div class="preloader">
            <div class="vertical-centered-box">
                <div class="content">
                    ...
                    <img src="{{ asset('public/alfurqan/assets/images/preloader.png') }}" alt="">
                </div>
            </div>
        </div>
        <!-- end preloader -->
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                                ...
                                <div id="navbar" class="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="{{ route('jummah') }}">{{ __('admin_local.Jummah') }}</a></li>
                                                <li><a href="{{ route('events') }}">{{ __('admin_local.Events') }}</a></li>
                                            </ul>
                                        </li>
                            ...
                            <div class="col-lg-2 col-md-2 col-3">
                                <a href="{{ route('donation.index') }}" class="theme-btn py-1 px-2" style="border-radius: 5px;top:3px;cursor:pointer;">{{ __('admin_local.Donate') }} </a>
                            </div>
                            <div class="col-lg-2 col-md-2 col-1">
                                <div class="header-right">
                                    <div class="header-search-form-wrapper">
                                        <div class="cart-search-contact">
                                            <button class="search-toggle-btn bg-dark"><i class="ti-world"></i> </button>
                                            {{-- <button class="search-toggle-btn"><i class="ti-world"></i> {{ __('admin_local.Language') }}</button> --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget link-widget s2">
                                <div class="widget-title">
                                    <h3>{{ __('admin_local.Quick Links') }}</h3>
                                </div>
                                <ul>
                                    <li><a href="{{ url('/') }}">{{ __('admin_local.Home') }}</a></li>
                                    <li><a href="{{ route('donation.index') }}">{{ __('admin_local.Donate') }}</a></li>
                ...
                <div class="container">
                    <div class="row g-0">
                        <div class="col col-lg-6 col-12">
                            <p class="copyright"> {{ __('admin_local.Copyright') }} &copy; {{ date('Y') }} Al Furqan Isalamic Institute {{ __('admin_local.All Rights Reserved') }}</p>
                        </div>
                        <div class="col col-lg-6 col-12">
                            <ul>
                                <li>
                                    <a href="#">{{ __('admin_local.Privacy and Policy') }}</a>
                                </li>
                                <li>
                                    <a href="#">{{ __('admin_local.About') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
